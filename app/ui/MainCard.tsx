    ...
    <div className='flex flex-col w-3/4 border border-slate-200 rounded-lg shadow-lg'>
      ...
      <div className='px-2 flex flex-col gap-2 text-center my-2 md:gap-6'>
        ...
        <Link href='/products' className=''>
          <button className=" w-full text-purple-500-500 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 font-medium rounded-lg text-xl px-5 py-2.5 text-center mr-2 mb-2">Ver mas</button>
        </Link>
      </div>
    </div>
  )
